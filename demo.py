...
def openrouter_llm(instruction, context=None, **kwargs):
    """LLM wrapper compatible with taskflowAI."""
    ...
    response_data = get_response(model_id, full_prompt)
